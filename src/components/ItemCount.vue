...
<template>
    <section class="flex items-center gap-2">
        ...
        <span :class="{'text-error': props.highlight && props.count.shulker_box != 0}">
        ...
        <span :class="{'text-error': props.highlight && props.count.stack != 0}">
            {{ props.count.stack }}
        </span>
        <img
        ...
        <span :class="{'text-error': props.highlight && props.count.single != 0}">
            {{ props.count.single }}
        </span>
    </section>
</template>
